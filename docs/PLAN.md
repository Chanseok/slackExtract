...
## Phase 8: 스마트 다운로드 (Smart Download) - 완료
...
- [x] **자동 등록 (Auto-Registration):** 인덱스에 없는 파일 분석 시 자동으로 채널 등록
...
- [x] **채널 정보 표시:** 멤버 수, 유형, 상태를 한 줄에 표시
  - 예: `[x] 🔒 sales-germany    (12 members)  ⬇️ Downloaded`
- [x] **상태바 (Status Bar):**
  - Workspace 이름
  - 전체/참여/선택된 채널 수
  - 캐시 상태 및 갱신 시간
- [x] **하단 도움말 바:** 사용 가능한 키보드 단축키 표시
